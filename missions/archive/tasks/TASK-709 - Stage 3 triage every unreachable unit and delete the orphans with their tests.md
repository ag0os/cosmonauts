...
updatedAt: '2026-09-23T13:55:07.242Z'
---
...
<!-- AC:BEGIN -->
- [x] #1 After this task the reachability command exits zero with no unreachable unit and no staged entry whose owner is not live (B-010).
- [x] #2 Every deleted module is listed in the commit with the reason, and no deleted module is imported by anything that ships.
- [x] #3 check-artifacts, lint, typecheck and the full suite pass.
<!-- AC:END -->
