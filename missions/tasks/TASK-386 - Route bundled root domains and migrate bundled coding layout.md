...
- [x] #2 The first-party bundled coding package declares a single root domain with `path: "."` and has no active runtime/test/doc references to the old `bundled/coding/coding/**` layout.
