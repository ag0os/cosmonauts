...
- [ ] #2 Bound artifact-conformance passes for all B-001…B-011 behavior entries: each root-relative referenced test exists and contains its exact `@cosmo-behavior plan:test-health-audit#B-0NN` marker.
