...
- [ ] #7 Dependency direction remains `cli/reporter/probe/census/artifacts/source-census -> schema`; census logic imports no product modules, and objective observations cannot populate human-reviewed role, authority, chain, criticality, disposition, or portfolio sufficiency.
