...
updatedAt: '2026-06-30T18:18:09.488Z'
---
...
<!-- AC:BEGIN -->
- [x] #1 typecheck, lint, and the full test suite pass with all B-001..B-012 behaviors green
- [x] #2 no runtime references to lastIdNumber remain outside legacy-stripping/test/doc code (grep-verified) and no orphaned create-path imports linger
- [x] #3 archive scanning is confined to the create-only allocation helper; active query/lookup paths remain active-only
- [x] #4 every marker @cosmo-behavior plan:task-id-system#B-001..#B-012 is present in the referenced tests
<!-- AC:END -->
