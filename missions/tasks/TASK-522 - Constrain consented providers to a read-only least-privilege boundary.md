...
updatedAt: '2026-07-29T19:19:13.730Z'
---
...
<!-- AC:BEGIN -->
- [x] #1 A malicious provider fixture that ignores no-cache/dry-run cannot modify repository or user-owned sentinel files through a capability invocation.
- [x] #2 Provider children receive only an explicit allowlisted environment and no model/API credentials or unrelated host secrets.
- [x] #3 The project view is OS-enforced read-only for provider execution, or capability execution reports failed/unavailable rather than weakening INV-5.
- [x] #4 Pinned Fallow status and capability flows remain functional inside the enforced boundary.
<!-- AC:END -->
