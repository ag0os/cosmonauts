...
- [ ] #3 The exported source, judgment, limits, evidence, index-pressure, consolidator, options, recovery, and discriminated result contracts match the plan's exact closed shapes, and `createLivingMemoryConsolidator()` is the sole dependency-injected composition seam.
