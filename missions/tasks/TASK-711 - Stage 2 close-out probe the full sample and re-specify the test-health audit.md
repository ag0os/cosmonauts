...
- [ ] #3 Every sampled row names a production mutation target (helper- and subprocess-admitted declarations included, hand-probed where probe.ts cannot route them), and the probe table carries a resolved-tool-name row (B-007).
