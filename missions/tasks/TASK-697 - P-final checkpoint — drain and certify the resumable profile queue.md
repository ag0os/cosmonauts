...
<!-- AC:BEGIN -->
- [ ] #1 The current-epoch persisted queue reports no pending or invalid profile unit after bounded assessing-agent sessions, with machine-bounded concurrency and disjoint shard ownership evidenced throughout.
