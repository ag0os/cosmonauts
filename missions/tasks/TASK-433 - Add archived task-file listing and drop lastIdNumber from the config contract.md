...
updatedAt: '2026-06-30T17:36:17.602Z'
---
...
<!-- AC:BEGIN -->
- [ ] #1 B-008: listArchivedTaskFiles returns sorted .md filenames from missions/archive/tasks/ and [] when that directory is absent
- [ ] #2 Active and archived listing share one missing-dir/filter/sort helper (no divergent copies)
- [ ] #3 B-008: ForgeTasksConfig no longer declares lastIdNumber; loadConfig/saveConfig strip it so a legacy file is tolerated without error and never re-emitted
- [ ] #4 file-system tests cover archived listing and legacy stripping, carry the #B-008 marker, and pass
<!-- AC:END -->
