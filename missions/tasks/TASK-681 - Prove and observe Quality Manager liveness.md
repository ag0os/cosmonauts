...
<!-- AC:BEGIN -->
- [ ] #1 B-012 an executable integration test runs a synthetic silent Quality Manager step through runDurableChain and reaches terminal or terminal-blocked state within enforced test policy.
