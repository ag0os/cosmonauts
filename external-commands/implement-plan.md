...
- Report: all tasks Done or Cancelled; gate results; the no-churn / plan-specific guarantees you verified; QM verdict; codex findings + dispositions; and anything still open.
